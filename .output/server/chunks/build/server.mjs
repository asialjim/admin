import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, inject, computed, unref, createElementBlock, openBlock, createElementVNode, getCurrentInstance, ref, hasInjectionContext, isRef, warn, h, Suspense, Fragment, mergeProps, renderSlot, normalizeClass, createVNode, Transition, withCtx, withDirectives, normalizeStyle, createTextVNode, toDisplayString, vShow, watch, shallowReactive, createBlock, createCommentVNode, resolveDynamicComponent, withModifiers, useSSRContext, createApp, provide, nextTick, isVNode, toRef, onErrorCaptured, onServerPrefetch, reactive, effectScope, shallowRef, isReadonly, isShallow, isReactive, toRaw, render, defineAsyncComponent, getCurrentScope } from 'vue';
...
import { NOOP, isString, isObject, hasOwn, isFunction, isArray } from '@vue/shared';
import { fromPairs, set, get as get$1 } from 'lodash-unified';
...
const navigateTo = (to, options) => {
  ...
  {
    if (nuxtApp.ssrContext) {
      const fullPath = typeof to === "string" || isExternal ? toPath : router2.resolve(to).fullPath || "/";
      ...
      if (!isExternal && inMiddleware) {
        router2.afterEach((final) => final.fullPath === fullPath ? redirect(false) : void 0);
        return to;
      }
  ...
  return (options == null ? void 0 : options.replace) ? router2.replace(to) : router2.push(to);
};
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Dq8Zt-Nu.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-SbFLrX3d.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-B7mZFjbD.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-BrsjoNS9.mjs')
  },
  {
    name: "create-admin",
    path: "/create-admin",
    component: () => import('./create-admin-Dxy9aiM-.mjs')
  }
];
...
const plugin = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(nuxtApp) {
    ...
    const router2 = createRouter({
      ...
      scrollBehavior: (to, from, savedPosition) => {
        ...
        if (routerOptions.scrollBehavior) {
          router2.options.scrollBehavior = routerOptions.scrollBehavior;
          if ("scrollRestoration" in (void 0).history) {
            const unsub = router2.beforeEach(() => {
              unsub();
    ...
    nuxtApp.vueApp.use(router2);
    const previousRoute = shallowRef(router2.currentRoute.value);
    router2.afterEach((_to, from) => {
    ...
    const _route = shallowRef(router2.currentRoute.value);
    const syncCurrentRoute = () => {
      _route.value = router2.currentRoute.value;
    };
    ...
    if (!((_b = nuxtApp.ssrContext) == null ? void 0 : _b.islandContext)) {
      router2.afterEach(async (to, _from, failure) => {
    ...
    try {
      if (true) {
        ;
        [__temp, __restore] = executeAsync(() => router2.push(initialURL)), await __temp, __restore();
        ;
      }
      ;
      [__temp, __restore] = executeAsync(() => router2.isReady()), await __temp, __restore();
      ;
    } catch (error2) {
      [__temp, __restore] = executeAsync(() => nuxtApp.runWithContext(() => showError(error2))), await __temp, __restore();
    }
    const resolvedInitialRoute = router2.currentRoute.value;
    syncCurrentRoute();
    if ((_c = nuxtApp.ssrContext) == null ? void 0 : _c.islandContext) {
      return { provide: { router: router2 } };
    }
    ...
    router2.onError(async () => {
      delete nuxtApp._processingMiddleware;
      await nuxtApp.callHook("page:loading:end");
    });
    router2.afterEach(async (to, _from) => {
...
const getCurrentEnv = () => {
  if (import.meta && __vite_import_meta_env__ && "production") {
    return "production";
  }
...
const getCookie = (name) => {
  const cookieArr = (void 0).cookie.split(";");
...
const setCookie = (name, value, days = 7) => {
  ...
  (void 0).cookie = `${name}=${encodeURIComponent(value)};${expires};path=/`;
};
...
const responseInterceptor = async (response) => {
  ...
  try {
    ...
    if (data.code !== void 0 && data.code !== "0" && data.code !== 0) {
...
const checkSystemInitialized = async () => {
  ...
  try {
    ...
    return ((_a = response.data) == null ? void 0 : _a.initialized) || response.initialized || false;
  } catch (error) {
    return false;
  }
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ style: { "width": "100%", "height": "100%" } }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BA19x8vf.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-z5NP0tJ4.mjs'));
...
export { isBoolean as A, componentSizes as B, getProp as C, withNoopInstall as D, ElMessage as E, useGlobalSize as F, loading_default as G, ValidateComponentsMap as V, _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, api as d, entry$1 as default, buildProps as e, definePropType as f, useGlobalConfig as g, useNamespace as h, useId as i, useLocale as j, addUnit as k, ElIcon as l, isNumber as m, navigateTo as n, isFirefox as o, mutable as p, iconPropType as q, resolveRouteObject as r, success_filled_default as s, tryUseNuxtApp as t, useRouter as u, circle_close_default as v, withInstall as w, useSizeProp as x, view_default as y, hide_default as z };
